...
![캡처_2023_03_05_16_44_40_851](https://user-images.githubusercontent.com/111506781/222948382-30b2425b-270d-4e8e-a63c-ee7d00adbee6.png)
...
### 단순 반복 작업이 많았지만 코드를 최대한 줄이기 위해서 계속 생각하였다. 하지만 코드를 너무 많이 바꾸다 보니 시간이 오래 걸려서 다음에는 처음부터 구상을 하는게 나을거 같았다. 관련된 모든 변수들의 인과관계를 생각해야하는것이 복잡하였다. 
